...
angular.module('project')
  .controller('ProfileEditController', ['$scope', 'Users','$location','$routeParams','auth','Credentials','Projects','SweetAlert', function ($scope, Users,$location,$routeParams,auth,Credentials,Projects,SweetAlert) {
